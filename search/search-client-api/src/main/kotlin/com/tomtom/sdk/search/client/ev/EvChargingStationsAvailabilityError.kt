...
/**
 * Error caused by failure while calling the EV Charging Stations Availability API goes wrong.
 * Contains information about the cause of the failure.
 *
 * Important: This is a Public Preview API. It may be changed or removed at any time.
 */
class EvChargingStationsAvailabilityError(message: String = "") : SearchError(message)
